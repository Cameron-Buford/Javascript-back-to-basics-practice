...
// var filterArray = [1,2,'aasf','1','123',123];

// filter_list = (filterArray) => {
//   return filterArray.filter(x => typeof x === 'number')
// }
...
//KATA 7--- SUM OF TWO LOWEST POSITIVE INTEGERS
...
function sumTwoSmallestNumbers(numbers) {  
  let newSum = numbers.sort((a, b) => a-b)
  let addLowestSum = newSum[0] + newSum[1];
  return addLowestSum
}
